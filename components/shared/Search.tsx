  ...
  return (
    <div className="flex-center min-h-[54px] w-full overflow-hidden rounded-full bg-gray-50 px-4 py-2">
      ...
      <Input
        ...
        className="p-regular-16 border-0 bg-grey-5e outline-offset-0 placeholder:text-gray-500 focus:border-0 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-full"
      />
    </div>
  );
};
